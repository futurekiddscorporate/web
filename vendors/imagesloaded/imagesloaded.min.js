!function(global, factory) {
    ...
    return proto.on = function(eventName, listener) {
        if (eventName && listener) {
            ...
            return listeners.indexOf(listener) == -1 && listeners.push(listener),
            this
        }
    }
    ,
    proto.once = function(eventName, listener) {
        if (eventName && listener) {
            ...
            return onceListeners[listener] = !0,
            this
        }
    }
    ,
    ...
    proto.emitEvent = function(eventName, args) {
        ...
        if (listeners && listeners.length) {
            ...
            for (var onceListeners = this._onceEvents && this._onceEvents[eventName]; listener; ) {
                ...
                isOnce && (this.off(eventName, listener),
...
function(window, factory) {
    ...
    function ImagesLoaded(elem, options, onAlways) {
        return this instanceof ImagesLoaded ? ("string" == typeof elem && (elem = document.querySelectorAll(elem)),
        this.elements = makeArray(elem),
        this.options = extend({}, this.options),
        "function" == typeof options ? onAlways = options : extend(this.options, options),
    ...
    ImagesLoaded.prototype.addElementImages = function(elem) {
        ...
        this.options.background === !0 && this.addElementBackgroundImages(elem);
    ...
    ImagesLoaded.prototype.check = function() {
        ...
        this.hasAnyBroken = !1,
        this.images.length ? void this.images.forEach(function(loadingImage) {
    ...
    ImagesLoaded.prototype.progress = function(image, elem, message) {
        ...
        this.jqDeferred && this.jqDeferred.notify && this.jqDeferred.notify(this, image),
    ...
    LoadingImage.prototype.check = function() {
        ...
        return isComplete ? void this.confirm(0 !== this.img.naturalWidth, "naturalWidth") : (this.proxyImage = new Image,
    ...
    Background.prototype.check = function() {
        ...
        var isComplete = this.getIsImageComplete();
        isComplete && (this.confirm(0 !== this.img.naturalWidth, "naturalWidth"),
        this.unbindEvents())
    }
    ,
